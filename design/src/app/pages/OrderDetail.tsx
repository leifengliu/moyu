    ...
    <div className="min-h-screen bg-[#F8F6F3] pb-32">
      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#E8DED3]">
        ...
        <div className="px-6 pb-4 flex items-center gap-4">
          ...
          <h1 className="text-lg text-[#1A1A1A]" style={{ fontFamily: 'serif' }}>订单详情</h1>
        </div>
      </div>
      ...
      <div className="px-6 pb-6">
        <div className="bg-white rounded-lg p-6 border border-[#E8DED3]">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-[#1A1614] rounded-lg flex items-center justify-center flex-shrink-0">
